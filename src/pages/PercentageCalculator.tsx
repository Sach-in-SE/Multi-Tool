...
const PercentageCalculator = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-8">
      <h1 className="text-3xl font-bold text-gray-900 mb-8">Percentage Calculator</h1>
      ...
      {calculationType === 'basic' ? (
        ...
        <form onSubmit={calculatePercentageChange} className="space-y-6">
          <div>
            <label htmlFor="originalValue" className="block text-sm font-medium text-gray-700 mb-2">
              Original Value
            </label>
            <input
              type="number"
      ...
      {result && (
        <div className="mt-8 p-4 bg-indigo-50 rounded-lg text-center">
          <p className="text-xl font-semibold text-indigo-600">{result}</p>
        </div>
      )}

      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="p-4 bg-gray-50 rounded-md">
          <h3 className="text-lg font-medium text-gray-900 mb-2">Basic Percentage</h3>
        ...
        <div className="p-4 bg-gray-50 rounded-md">
          <h3 className="text-lg font-medium text-gray-900 mb-2">Percentage Change</h3>
          <p className="text-sm text-gray-600">
